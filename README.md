...
If you prefer using npm over yarn, you can, but make sure you have the user space setted up correctly [here](https://docs.npmjs.com/resolving-eacces-permissions-errors-when-installing-packages-globally) as in many systems this is not enabled by default.
